...
#cv2.getRotationMatrix2D((x, y))
pts_1 = np.float32([[135,45],[385, 45],[135, 230]])
pts_2 = np.float32([[135, 45], [385, 45], [150, 230]])

M = cv2.getAffineTransform(pts_1,pts_2)
dst_img = cv2.warpAffine(pts_1, M, (800, 800)) #tuple is size of resulting img


print(M)
cv2.imshow('Resized img', dst_img)
cv2.waitKey(0)
